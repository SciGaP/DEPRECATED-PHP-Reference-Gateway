...
/*
 **********Executing Echo Application on Trestles**********
...
public class EchoTrestles extends UserLogin {
  ...
  @Test
  public void testEchoTrestles() throws Exception {
    ...
    driver.findElement(By.id("experiment-name")).sendKeys(expName + "Echo-Trestles");
      waitTime (500);
    ...
    driver.findElement(By.id("Input_to_Echo")).sendKeys("Test Echo");
      waitTime (500);
