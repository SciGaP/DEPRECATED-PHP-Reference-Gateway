...
public class Untitled extends UserLogin {
  ...
  public void testUntitled() throws Exception {
    ...
    driver.findElement(By.cssSelector("div.create-app-interface-block > div.appInterfaceInputs > div.form-group.required > input[name=\"applicationName\"]")).sendKeys("TEST_APP1");
    ...
    driver.findElement(By.cssSelector("div.create-app-interface-block > div.appInterfaceInputs > div.form-group > input[name=\"applicationDescription\"]")).sendKeys("TEST APP Interface");
    ...
    driver.findElement(By.xpath("(//input[@value=''])[52]")).click();
  }
