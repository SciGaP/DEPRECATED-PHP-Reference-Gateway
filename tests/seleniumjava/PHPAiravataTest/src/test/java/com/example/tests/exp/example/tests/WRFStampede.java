...
public class WRFStampede extends UserLogin {
  ...
  public void testWRFStampede() throws Exception {
    ...
    driver.findElement(By.name("continue")).click();
      waitTime(500);
    driver.findElement(By.id("Config_Namelist_File")).sendKeys(ExpFileReadUtils.WRF_INPUT1);
      waitTime(500);
    driver.findElement(By.id("WRF_Boundary_File")).sendKeys(ExpFileReadUtils.WRF_INPUT2);
      waitTime(500);
    driver.findElement(By.id("WRF_Initial_Conditions")).sendKeys(ExpFileReadUtils.WRF_INPUT3);
      waitTime(500);
