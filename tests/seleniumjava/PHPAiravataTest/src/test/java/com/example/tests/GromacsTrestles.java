...
/*
 **********Executing Gromacs Application on Trestles**********
...
public class GromacsTrestles extends UserLogin {
  ...
  @Test
  public void testGromacsTrestles() throws Exception {
    ...
    driver.findElement(By.id("experiment-name")).sendKeys(expName + "Gromacs-Trestles");
      waitTime(500);
    ...
    driver.findElement(By.name("continue")).click();
      waitTime(500);
    driver.findElement(By.id("GROMOS_Coordinate_File")).sendKeys(path + "/Trestles/GROMACS/pdb1y6l.gro");
      waitTime(500);
    driver.findElement(By.id("Portable_Input_Binary_File")).sendKeys(path + "/Trestles/GROMACS/pdb1y6l-EM-vacuum.tpr");
      waitTime(500);
