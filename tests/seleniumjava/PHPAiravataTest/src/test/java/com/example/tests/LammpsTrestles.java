...
/*
 **********Executing Lammps Application on Trestles**********
...
public class LammpsTrestles extends UserLogin {
  ...
  @Test
  public void testLammpsTrestles() throws Exception {
    ...
    driver.findElement(By.id("experiment-name")).sendKeys(expName + "Lammps-Trestles");
      waitTime(500);
    ...
    driver.findElement(By.name("continue")).click();
      waitTime(500);
    driver.findElement(By.id("Friction_Simulation_Input")).sendKeys(path + "/Trestles/LAMMPS/in.friction");
      waitTime(500);
