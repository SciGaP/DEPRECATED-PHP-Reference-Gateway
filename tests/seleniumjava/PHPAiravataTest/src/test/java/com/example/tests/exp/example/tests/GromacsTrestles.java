...
public class GromacsTrestles extends UserLogin {
  ...
  public void testGromacsTrestles() throws Exception {
    ...
    driver.findElement(By.name("continue")).click();
      waitTime(500);
    driver.findElement(By.id("GROMOS_Coordinate_File")).sendKeys(ExpFileReadUtils.GROMACS_INPUT1);
      waitTime(500);
    driver.findElement(By.id("Portable_Input_Binary_File")).sendKeys(ExpFileReadUtils.GROMACS_INPUT2);
      waitTime(500);
