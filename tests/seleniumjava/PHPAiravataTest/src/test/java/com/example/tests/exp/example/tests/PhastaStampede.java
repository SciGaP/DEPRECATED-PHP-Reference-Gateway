...
/*
 **********Executing Phasta Application on Stampede**********
...
public class PhastaStampede extends UserLogin {
  ...
  @Test
  public void testPhastaStampede() throws Exception {
    ...
    driver.findElement(By.id("experiment-name")).sendKeys(expName + "Phasta-Stampede");
      waitTime(500);
    ...
    new Select(driver.findElement(By.id("project"))).selectByVisibleText(ExpFileReadUtils.readProperty("project.name"));
      waitTime (500);
    new Select(driver.findElement(By.id("application"))).selectByVisibleText("PHASTA");
      waitTime (500);
    driver.findElement(By.name("continue")).click();
    driver.findElement(By.id("Mesh_Description_File")).sendKeys(ExpFileReadUtils.PHASTA_INPUT1);
    driver.findElement(By.id("Parasolid_Geometric_Model")).sendKeys(ExpFileReadUtils.PHASTA_INPUT2);
    driver.findElement(By.id("Problem_Definition")).sendKeys(ExpFileReadUtils.PHASTA_INPUT3);
    driver.findElement(By.id("Solver_Inp")).sendKeys(ExpFileReadUtils.PHASTA_INPUT4);
      waitTime (500);
