...
public class TrinityStampede extends UserLogin {
  ...
  public void testTrinityStampede() throws Exception {
    ...
    driver.findElement(By.name("continue")).click();
      waitTime(500);
    driver.findElement(By.id("RNA_Seq_Left_Input")).sendKeys(ExpFileReadUtils.TRINITY_INPUT1);
      waitTime(500);
    driver.findElement(By.id("RNA_Seq_Right_Input")).sendKeys(ExpFileReadUtils.TRINITY_INPUT2);
      waitTime (500);
