...
public class WRFStampede extends UserLogin {
  ...
  public void testWRFStampede() throws Exception {
    ...
    driver.findElement(By.name("continue")).click();
      waitTime(500);
    driver.findElement(By.id("Config_Namelist_File")).sendKeys(path + "/Stampede/WRF/namelist.input");
      waitTime(500);
    driver.findElement(By.id("WRF_Boundary_File")).sendKeys(path + "/Stampede/WRF/wrfbdy_d01");
      waitTime(500);
    driver.findElement(By.id("WRF_Initial_Conditions")).sendKeys(path + "/Stampede/WRF/wrfinput_d01");
