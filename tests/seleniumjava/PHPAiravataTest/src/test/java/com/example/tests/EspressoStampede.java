...
public class EspressoStampede extends UserLogin {
  ...
  public void testEspressoStampede() throws Exception {
    ...
    driver.findElement(By.name("continue")).click();
      waitTime (500);
    driver.findElement(By.id("AI_Primitive_Cell")).sendKeys(path + "/Stampede/ESPRESSO/Al.sample.in");
      waitTime (500);
    driver.findElement(By.id("AI_Pseudopotential_File")).sendKeys(path + "/Stampede/ESPRESSO/Al.pz-vbc.UPF");
      waitTime (500);
